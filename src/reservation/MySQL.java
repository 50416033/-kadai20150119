...
public class MySQL {
	...
	public MySQL() {
		...
		this.dbname  = "50416033";         // データベース名;
		this.url = "jdbc:mysql://" + server + "/" + dbname + "?useUnicode=true&characterEncoding=UTF-8";
		this.user = "50416033";         // データベース作成ユーザ名;
		this.password  = "50416033";     // データベース作成ユーザパスワード;
...
public ResultSet getdate(String userid){
...
public ResultSet facilityReservation(String facility){
	String sql = "SELECT * FROM reservation WHERE facility_name ='"+facility+"';";
	ResultSet rs = null;
	try {
		rs = stmt.executeQuery (sql);  //try catchで囲む
